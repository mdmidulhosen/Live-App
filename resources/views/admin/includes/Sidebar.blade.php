        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarProjects">
                    <ul class="side-nav-second-level">
{{--                        <li>--}}
{{--                            <a href="{{route('InAdmin.Vendor.CreatePage')}}">Add Shop</a>--}}
{{--                        </li>--}}
                        <li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarProjects2">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{route('InAdmin.Order.IndexPage')}}">Order List</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarProjects3">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{route('InAdmin.Home.Slider.Create')}}">Add Banner</a>
                        </li>
            ...
            <li class="side-nav-item">
                <a href="{{route('InAdmin.LogoutPage')}}" class="side-nav-link">
                    <i class="uil-rss"></i>
                    <span> Logout </span>
                </a>
            </li>
