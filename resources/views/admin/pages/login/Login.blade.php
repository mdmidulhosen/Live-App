...
<head>
        <meta charset="utf-8" />
        <title>in-admin | {{ config('app.name'); }}</title>
    ...
    <body class="authentication-bg">
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-header py-4 text-center bg-primary">
                                <a href="index.html">
                                    <span><img src="{{ asset('images/official/'.config('app.inlogo')) }}" alt="logo" height="22"></span>
                                </a>
                            </div>
        ...
        <footer class="footer footer-alt">
            2022 - <script>document.write(new Date().getFullYear())</script> © {{ config('app.name') }} - in-admin by &nbsp; <a href="https://infoniam.com/"> Infoniam Technologies</a>
        </footer>
        <!-- Vendor js -->
