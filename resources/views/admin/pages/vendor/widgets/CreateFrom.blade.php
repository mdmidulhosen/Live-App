                ...
                <form action="{{route('InAdmin.Vendor.CreateProcess')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text"  class="form-control" name="shop_url" required >
                    ...
                    <div class="row g-2">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="shop_phone" class="form-control" required >
                    ...
                    <div class="row g-2">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="shop_zip" required>
                    ...
                    <div class="row g-1">
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" cols="5" name="shop_description"></textarea>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control" name="shop_youtube">
                        </div>
                    </div>
